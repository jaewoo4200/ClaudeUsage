...
enum L10n {
    ...
    static let strings: [String: [AppLanguage: String]] = [
        ...
        "breakdown_title": [.ko: "주간 사용 내역", .en: "Weekly breakdown"],
        "breakdown_claude_title": [.ko: "Claude · 주간 사용 내역", .en: "Claude · weekly breakdown"],
        "breakdown_share": [.ko: "주간 사용량의 서비스별 비율", .en: "Weekly usage by service"],
        ...
        // ==== Companion ====
        "section_companion": [.ko: "펫", .en: "Companion"],
        "pet_enabled_desc": [.ko: "사용량에 따라 표정이 달라져요", .en: "Reacts to your current usage"],
        "companion_character": [.ko: "캐릭터", .en: "Character"],
        "companion_character_desc": [.ko: "9가지 펫 중 하나를 골라요", .en: "Choose one of nine companions"],
        "companion_mimo_desc": [.ko: "노트북으로 함께 일하는 로봇", .en: "A laptop robot that works with you"],
        "companion_lumi_desc": [.ko: "페이스를 빛으로 알려주는 조명", .en: "A desk light that shows your pace"],
        "companion_kumo_desc": [.ko: "한도에 따라 날씨가 변하는 구름", .en: "A cloud whose weather follows usage"],
        "companion_dot_desc": [.ko: "코드가 흐르는 픽셀 생명체", .en: "A pixel creature filled with code"],
        "companion_navi_desc": [.ko: "Claude와 Codex를 도는 탐사 드론", .en: "A drone orbiting Claude and Codex"],
        "companion_bori_desc": [.ko: "꼬리와 표정이 풍부한 여우 연구원", .en: "An expressive fox researcher"],
        "companion_muru_desc": [.ko: "기록과 함께 자라는 버섯 친구", .en: "A mushroom friend that grows with history"],
        "companion_tori_desc": [.ko: "사용 속도를 날갯짓으로 전하는 새", .en: "A bird whose wings show your pace"],
        "companion_pico_desc": [.ko: "한도를 배터리처럼 느끼는 로봇 고양이", .en: "A robot cat that treats quota like a battery"],
        ...
        "pet_message_focused": [.ko: "집중해서 함께 작업 중이에요", .en: "Focused and working with you"],
        ...
        "today_tokens_details": [.ko: "오늘 토큰 상세", .en: "Today's token details"],
        "today_tokens_pending": [.ko: "집계 대기", .en: "Pending"],
        "today_tokens_partial": [.ko: "일부 %@", .en: "Partial %@"],
        "today_tokens_disabled": [.ko: "로컬 집계 꺼짐", .en: "Local counting off"],
        "today_tokens_unavailable": [.ko: "조회 불가", .en: "Unavailable"],
        "today_tokens_claude_source": [.ko: "이 Mac의 Claude Code · 캐시 포함", .en: "Claude Code on this Mac · includes cache"],
        "today_tokens_codex_source": [.ko: "Codex 계정 · 서버 일별 집계", .en: "Codex account · server daily totals"],
        "today_tokens_codex_pending": [.ko: "서버가 오늘 날짜의 토큰을 아직 제공하지 않았습니다.", .en: "The server has not provided tokens for today's date yet."],
        "today_tokens_last_report": [.ko: "Codex 최근 서버 집계", .en: "Latest Codex server total"],
        "today_tokens_unit": [.ko: "토큰", .en: "tokens"],
